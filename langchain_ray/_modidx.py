...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'langchain_ray.chains': { 'langchain_ray.chains.chain_fn': ('chains.html#chain_fn', 'langchain_ray/chains.py'),
            ...
            'langchain_ray.pdf.chains': { 'langchain_ray.pdf.chains.docs_faiss_chain': ( 'pdf/pdf_chains.html#docs_faiss_chain',
                                          ...
                                          'langchain_ray.pdf.chains.docs_to_faiss_chain': ( 'pdf/pdf_chains.html#docs_to_faiss_chain',
                                                                                            'langchain_ray/pdf/chains.py'),
                                          ...
                                          'langchain_ray.pdf.chains.pdf_cats_chain': ( 'pdf/pdf_chains.html#pdf_cats_chain',
                                                                                       'langchain_ray/pdf/chains.py'),
                                          'langchain_ray.pdf.chains.pdf_docs_df_chain': ( 'pdf/pdf_chains.html#pdf_docs_df_chain',
                                                                                          'langchain_ray/pdf/chains.py'),
                                          'langchain_ray.pdf.chains.pdf_ems_chain': ( 'pdf/pdf_chains.html#pdf_ems_chain',
                                                                                      'langchain_ray/pdf/chains.py'),
                                          'langchain_ray.pdf.chains.pdfs_to_docs_chain': ( 'pdf/pdf_chains.html#pdfs_to_docs_chain',
                                                                                           'langchain_ray/pdf/chains.py'),
                                          'langchain_ray.pdf.chains.pdfs_to_faiss_chain': ( 'pdf/pdf_chains.html#pdfs_to_faiss_chain',
                                                                                            'langchain_ray/pdf/chains.py')},
            'langchain_ray.pdf.utils': { 'langchain_ray.pdf.utils.bold_text': ( 'pdf/pdf_utils.html#bold_text',
                                         ...
                                         'langchain_ray.pdf.utils.docs_to_faiss': ( 'pdf/pdf_utils.html#docs_to_faiss',
                                                                                    'langchain_ray/pdf/utils.py'),
                                         'langchain_ray.pdf.utils.index_names': ( 'pdf/pdf_utils.html#index_names',
                                                                                  'langchain_ray/pdf/utils.py'),
                                         ...
                                         'langchain_ray.pdf.utils.pdf_files': ( 'pdf/pdf_utils.html#pdf_files',
                                                                                'langchain_ray/pdf/utils.py'),
                                         'langchain_ray.pdf.utils.pdfs_to_docs': ( 'pdf/pdf_utils.html#pdfs_to_docs',
                                                                                   'langchain_ray/pdf/utils.py'),
                                         ...
                                         'langchain_ray.pdf.utils.process_text': ( 'pdf/pdf_utils.html#process_text',
                                                                                   'langchain_ray/pdf/utils.py'),
                                         'langchain_ray.pdf.utils.search_faiss': ( 'pdf/pdf_utils.html#search_faiss',
                                                                                   'langchain_ray/pdf/utils.py'),
