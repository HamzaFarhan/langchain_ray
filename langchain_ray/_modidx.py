  ...
  'syms': { 'langchain_ray.chains': { 'langchain_ray.chains.chain_fn': ('chains.html#chain_fn', 'langchain_ray/chains.py'),
            ...
            'langchain_ray.indexing.chains': { 'langchain_ray.indexing.chains.docs_to_faiss_chain': ( 'indexing/indexing_chains.html#docs_to_faiss_chain',
                                               ...
                                               'langchain_ray.indexing.chains.pdfs_to_faiss_chain': ( 'indexing/indexing_chains.html#pdfs_to_faiss_chain',
                                                                                                      'langchain_ray/indexing/chains.py')},
            'langchain_ray.indexing.utils': { 'langchain_ray.indexing.utils.df_docs_ems': ( 'indexing/indexing_utils.html#df_docs_ems',
                                                                                            'langchain_ray/indexing/utils.py'),
                                              'langchain_ray.indexing.utils.docs_ems': ( 'indexing/indexing_utils.html#docs_ems',
                                                                                         'langchain_ray/indexing/utils.py'),
                                              ...
                                              'langchain_ray.indexing.utils.search_faiss': ( 'indexing/indexing_utils.html#search_faiss',
                                                                                             'langchain_ray/indexing/utils.py')},
            'langchain_ray.ner.chains': { 'langchain_ray.ner.chains.EduNER': ('ner/ner_chains.html#eduner', 'langchain_ray/ner/chains.py'),
                                          'langchain_ray.ner.chains.JobNER': ('ner/ner_chains.html#jobner', 'langchain_ray/ner/chains.py')},
