...
# %% auto 0
__all__ = ['cid_to_char', 'process_text', 'bold_text', 'print_doc', 'create_pdf_df', 'pdf_files', 'create_idx_q_df',
           'index_names', 'doc_proc_text', 'pdf_docs', 'pdfs_to_docs', 'df_pdf_docs_', 'df_pdf_docs', 'text_cat',
           'docs_cat', 'df_docs_cat', 'docs_ems', 'df_docs_ems', 'df_to_faiss', 'docs_to_faiss', 'df_search_faiss',
           'search_faiss']
...
def pdfs_to_docs(
    ...
    docs = [pdf_docs(pdf, splitter=splitter, proc=proc) for pdf in pdfs]
    return flatten_list(docs)
